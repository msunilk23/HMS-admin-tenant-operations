...
export const goodsReceiptService = {
  ...
  create: (data: { purchase_order_id: string; received_date?: string; supplier_invoice_number?: string; supplier_invoice_date?: string; notes?: string }) => apiClient.post<GoodsReceipt>('/pharmacy/grn', data).then(r => r.data),
