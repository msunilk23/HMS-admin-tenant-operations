...
export const masterDataService = {
  ...
  createSupplier: (data: Record<string, string | boolean>) => apiClient.post('/pharmacy/suppliers', data).then(r => r.data),
  updateSupplier: (id: string, data: Record<string, string | boolean>) => apiClient.put(`/pharmacy/suppliers/${id}`, data).then(r => r.data),
  deactivateSupplier: (id: string) => apiClient.post(`/pharmacy/suppliers/${id}/deactivate`).then(r => r.data),
