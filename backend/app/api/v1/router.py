...
from app.api.v1.pharmacy_retail import router as pharmacy_retail_router
...
api_router.include_router(pharmacy_retail_router, prefix="/pharmacy/retail", tags=["pharmacy-retail"], **_tenant_guard)
